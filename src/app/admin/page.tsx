...
export default function AdminDashboard() {
  ...
  const [stats, setStats] = useState({ totalMerchants: 0, totalEvents: 0, totalAttendees: 0, totalRevenue: 0 })
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const { data: profile } = await supabase
        ...
        .eq('id', user.id)
        .single()
      if (profile?.role !== 'admin') { router.push('/merchant'); return }
  ...
  <aside className="sidebar">
    ...
    <nav className="nav-section">
      ...
      <button className="nav-item" data-page="approvals">
        <button className="nav-item" data-page="proofs" onClick={() => router.push("/admin/proofs")}>
    ...
    <div className="page page-content" data-page-id="overview" id="page-overview">
      ...
      <div className="kpi-row">
        <div className="kpi-card">
          ...
          <div className="kpi-value">{stats.totalMerchants.toLocaleString()}</div>
        ...
        <div className="kpi-card">
          ...
          <div className="kpi-value">{stats.totalEvents.toLocaleString()}</div>
          <div className="kpi-trend up">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/></svg>
